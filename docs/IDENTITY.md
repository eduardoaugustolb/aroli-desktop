# Umbra Liminal Identity

## Concept

**Threshold** is the crossing between the stable Omarchy base and the
personal Umbra surface. That is why Liminal does not use a fixed palette as
...
- Full name: **Umbra Liminal**.
- Short form: **Liminal**, when the Umbra context is clear.
